...
<Link to={`/details/${_id}`}>
    ...
    <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between px-3">
            ...
            <button onClick={()=>{addToCart(_id)}} className="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</button>
        </div>
